<!--INCLUDING DATAA=BASE FILE TO THE WEBPAGE-->
<?php
  ...
  <section class="container">
    <div class="row">
      <div class="col-md-5 mx-auto">
        <div class="card">
          <div class="card-header text-center guju1  text-dark">
            <h2>Insert Data</h2>
          </div>
...
<!--              FORM TO ADD DATA TO THE TABLE-->
            <form action="add.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control transparent-input" name="username" placeholder="Enter username" required="">
                </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="plag">phone:</label>
                    <input type="text" class="form-control" name="phone" placeholder="Enter phone number" required="">
                </div>
                <div class="form-group">
                    <label for="plag">mobile:</label>
